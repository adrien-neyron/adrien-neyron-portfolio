...
<template>
  <div class="p-4 sm:p-8 max-w-4xl">
    <div class="mb-8">
      ...
      <h1 class="text-2xl font-bold mt-2" style="font-family: var(--font-title);">Nouvel article</h1>
    </div>
    ...
    <div class="p-4 sm:p-6 rounded-xl border" style="border-color: color-mix(in srgb, var(--color-accent) 15%, transparent); background-color: var(--color-surface);">
      <AdminCarnetForm :loading="loading" @submit="handleSubmit" />
    </div>
  </div>
</template>
